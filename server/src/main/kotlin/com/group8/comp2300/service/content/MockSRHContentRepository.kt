...
class MockSRHContentRepository : SRHContentRepository {
    ...
    private val contents = listOf(
        SRHContent(
            ...
            description = "A comprehensive guide to different contraception methods including pills, IUDs, and implants. Learn about effectiveness, side effects, and how to choose the right method for you.",
        ...
        SRHContent(
            ...
            description = "Learn about STI prevention methods, testing, and safe practices. This video covers everything from condom use to regular testing schedules.",
        ...
        SRHContent(
            ...
            description = "What to expect during the first trimester of pregnancy. Covers symptoms, nutrition, prenatal care, and when to see a doctor.",
            contentType = ContentType.ARTICLE,
        ...
        SRHContent(
            ...
            description = "Learn about the different phases of your menstrual cycle, what's normal, and when to seek medical advice.",
            contentType = ContentType.ARTICLE,
        ...
        SRHContent(
            ...
            description = "Video guide on building healthy relationships, setting boundaries, and effective communication with partners.",
            contentType = ContentType.VIDEO,
        ...
        SRHContent(
            ...
            description = "Information about emergency contraception options, how they work, and when to use them.",
            contentType = ContentType.ARTICLE,
            topics = listOf(ContentTopic.CONTRACEPTION),
    ...
    override fun getById(id: String): SRHContent? {
        return contents.find { it.id == id }
    }

    override fun getAll(): List<SRHContent> {
        return contents
    }
}
