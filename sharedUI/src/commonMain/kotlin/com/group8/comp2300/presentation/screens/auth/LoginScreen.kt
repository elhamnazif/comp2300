...
fun LoginScreen(
    ...
    viewModel: com.group8.comp2300.presentation.screens.auth.AuthViewModel = koinViewModel(),
    onDismiss: () -> Unit = {}
) {
    ...
    if (state.showDatePicker) {
        ...
        DatePickerDialog(
            onDismissRequest = { viewModel.onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ShowDatePicker(false)) },
            confirmButton = {
                TextButton(
                    onClick = {
                        viewModel.onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.DateOfBirthChanged(dateState.selectedDateMillis))
                    }
                ) {
            ...
            dismissButton = {
                TextButton(onClick = { viewModel.onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ShowDatePicker(false)) }) {
    ...
    Scaffold(modifier = modifier) { innerPadding ->
        Column(
            ...
            _root_ide_package_.com.group8.comp2300.presentation.screens.auth.HeaderSection(
                isRegistering = state.isRegistering,
                step = state.step,
                onBack = { viewModel.onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.PrevStep) }
            )
            ...
            if (state.isRegistering && state.step == 1) {
                _root_ide_package_.com.group8.comp2300.presentation.screens.auth.PersonalDetailsStep(
                    state,
                    viewModel::onEvent
                )
            } else {
                _root_ide_package_.com.group8.comp2300.presentation.screens.auth.CredentialsStep(
                    state,
                    viewModel::onEvent
                )
            }
            ...
            // Action Buttons
            _root_ide_package_.com.group8.comp2300.presentation.screens.auth.ActionButtons(
                state = state,
            ...
            if (state.step == 0) {
                _root_ide_package_.com.group8.comp2300.presentation.screens.auth.FooterSection(
                    isRegistering = state.isRegistering,
                    onToggleMode = { viewModel.onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ToggleAuthMode) },
...
@Composable
private fun CredentialsStep(state: com.group8.comp2300.presentation.screens.auth.AuthViewModel.State, onEvent: (com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent) -> Unit) {
    Column {
        val focusManager = LocalFocusManager.current

        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.AuthTextField(
            value = state.email,
            onValueChange = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.EmailChanged(
                        it
                    )
                )
            },
        ...
        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.AuthTextField(
            ...
            onValueChange = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.PasswordChanged(
                        it
                    )
                )
            },
            ...
            trailingIcon = {
                IconButton(onClick = { onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.TogglePasswordVisibility) }) {
                    val icon =
        ...
        if (state.isRegistering) {
            Row(
                ...
                modifier = Modifier.fillMaxWidth().clickable { onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ToggleTerms) }
            ) {
                Checkbox(
                    checked = state.termsAccepted,
                    onCheckedChange = { onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ToggleTerms) }
                )
...
@Composable
private fun PersonalDetailsStep(state: com.group8.comp2300.presentation.screens.auth.AuthViewModel.State, onEvent: (com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent) -> Unit) {
    Column {
        val focusManager = LocalFocusManager.current
        ...
        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.AuthTextField(
            ...
            onValueChange = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.FirstNameChanged(
                        it
                    )
                )
            },
        ...
        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.AuthTextField(
            ...
            onValueChange = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.LastNameChanged(
                        it
                    )
                )
            },
        ...
        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.ClickableTextField(
            value = state.getFormattedDate(),
            label = stringResource(Res.string.auth_dob_label),
            leadingIcon = Icons.DateRangeW400Outlinedfill1,
            onClick = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ShowDatePicker(
                        true
                    )
                )
            }
        ...
        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.AuthDropdown(
            ...
            onSelectOption = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.GenderChanged(
                        it
                    )
                )
            }
        ...
        _root_ide_package_.com.group8.comp2300.presentation.screens.auth.components.AuthDropdown(
            ...
            onSelectOption = {
                onEvent(
                    _root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.OrientationChanged(
                        it
                    )
                )
            }
...
private fun ActionButtons(
    state: com.group8.comp2300.presentation.screens.auth.AuthViewModel.State,
    onEvent: (com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent) -> Unit,
    onLoginSuccess: () -> Unit
) {
    Column {
        Button(
            onClick = {
                onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.ClearError)
                when {
                    state.isRegistering && state.step == 0 -> {
                        if (state.isStep1Valid) onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.NextStep)
                    }

                    else -> onEvent(_root_ide_package_.com.group8.comp2300.presentation.screens.auth.AuthViewModel.AuthUiEvent.Submit(onLoginSuccess))
                }
            },
