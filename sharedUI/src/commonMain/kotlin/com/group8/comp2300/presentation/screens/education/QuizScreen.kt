...
fun QuizScreen(
    ...
    viewModel: com.group8.comp2300.presentation.screens.education.EducationViewModel = koinViewModel()
) {
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(innerPadding).fillMaxSize()) {
            ...
            if (showResults) {
                _root_ide_package_.com.group8.comp2300.presentation.screens.education.ResultsScreen(
                    quiz,
                    correctAnswersCount,
                    onRetake = {
                ...
                Column(
                    ...
                    currentQuestion.options.forEachIndexed { index, option ->
                        _root_ide_package_.com.group8.comp2300.presentation.screens.education.OptionCard(
                            option = option,
                            index = index,
                        ...
                        Card(
                                ...
                                CardDefaults.cardColors(
                                    containerColor =
                                        if (selectedAnswerIndex == currentQuestion.correctAnswerIndex) {
                                            _root_ide_package_.com.group8.comp2300.presentation.screens.education.CorrectGreen.copy(alpha = 0.9f) // theme-adaptive green
                                        } else {
                            ...
                            Column(modifier = Modifier.padding(16.dp)) {
                                Text(
                                    ...
                                    color =
                                        if (selectedAnswerIndex == currentQuestion.correctAnswerIndex) {
                                            _root_ide_package_.com.group8.comp2300.presentation.screens.education.CorrectOnGreen
                                        } else {
    ...
    Card(
        ...
        colors =
            CardDefaults.cardColors(
                containerColor =
                    when {
                        showResult && isCorrect -> _root_ide_package_.com.group8.comp2300.presentation.screens.education.CorrectGreen.copy(alpha = 0.9f)
        ...
        Row(modifier = Modifier.fillMaxWidth().padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
            Text(
                ...
                color = if (showResult && isCorrect) _root_ide_package_.com.group8.comp2300.presentation.screens.education.CorrectOnGreen else Color.Unspecified
            )
            if (showResult && isCorrect) {
                Text(
                    text = "✓",
                    color = _root_ide_package_.com.group8.comp2300.presentation.screens.education.CorrectOnGreen,
                    style = MaterialTheme.typography.headlineSmall,
                    fontWeight = FontWeight.Bold
                )
            }
        ...
        Card(
            ...
            colors =
                CardDefaults.cardColors(
                    containerColor =
                        when {
                            percentage >= 80 -> _root_ide_package_.com.group8.comp2300.presentation.screens.education.CorrectGreen.copy(alpha = 0.9f)
