...
fun BookingScreen(
    ...
    BottomSheetScaffold(
        ...
        sheetContent = {
            LazyColumn(
                ...
                items(clinics) { clinic ->
                    _root_ide_package_.com.group8.comp2300.presentation.screens.medical.ClinicCompactRow(
                        clinic = clinic,
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            _root_ide_package_.com.group8.comp2300.presentation.screens.medical.components.ClinicMap(
                clinics = clinics,
