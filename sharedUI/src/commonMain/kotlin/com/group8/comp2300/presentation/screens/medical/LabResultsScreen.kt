    ...
    Scaffold(
        ...
        Column(
            ...
            filteredResults.forEach { result ->
                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.LabResultCard(
                    result
                )
            }
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Row(
                ...
                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.StatusBadge(result)
            }
            ...
            if (expanded) {
                ...
                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.DetailRow(
