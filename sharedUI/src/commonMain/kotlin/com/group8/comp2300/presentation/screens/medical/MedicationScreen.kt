...
data class Medication(
    ...
    val color: Color,
    val status: com.group8.comp2300.presentation.screens.medical.MedicationStatus = _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationStatus.Active
)
...
fun MedicationScreen(modifier: Modifier = Modifier, isGuest: Boolean = false, onRequireAuth: () -> Unit = {}) {
    ...
    val medications = remember {
        mutableStateListOf<com.group8.comp2300.presentation.screens.medical.Medication>().apply {
            addAll(
                sampleMedications.map { domainMed ->
                    _root_ide_package_.com.group8.comp2300.presentation.screens.medical.Medication(
                        id = domainMed.id,
                        name = domainMed.name,
                        ...
                        color =
                            try {
                                ...
                                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedConstants.PresetColors.first()
                            },
                        status =
                            if (domainMed.status == com.group8.comp2300.domain.model.medical.MedicationStatus.ACTIVE) {
                                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationStatus.Active
                            } else {
                                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationStatus.Archived
                            }
                    )
                }
            )
    ...
    var editingMedication by remember { mutableStateOf<com.group8.comp2300.presentation.screens.medical.Medication?>(null) }
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            val activeMeds = medications.filter { it.status == _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationStatus.Active }
            item {
                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.SectionHeader(
            ...
            if (activeMeds.isEmpty()) {
                item {
                    _root_ide_package_.com.group8.comp2300.presentation.screens.medical.EmptyStateMessage(
                        stringResource(Res.string.medical_medication_empty_active)
                    )
                }
            } else {
                items(activeMeds, key = { it.id }) { med ->
                    _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationCard(
                        medication = med,
                        onClick = {
            ...
            val archivedMeds = medications.filter { it.status == _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationStatus.Archived }
        ...
        if (showBottomSheet) {
            ModalBottomSheet(onDismissRequest = { showBottomSheet = false }, sheetState = sheetState) {
                _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationFormSheet(
...
@Composable
fun MedicationCard(
    medication: com.group8.comp2300.presentation.screens.medical.Medication,
    onClick: () -> Unit,
...
fun MedicationFormSheet(
    medicationToEdit: com.group8.comp2300.presentation.screens.medical.Medication?,
    onSave: (com.group8.comp2300.presentation.screens.medical.Medication) -> Unit,
    ...
    var frequency by remember { mutableStateOf(medicationToEdit?.frequency ?: _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedConstants.Frequencies.first()) }
    var instructions by remember { mutableStateOf(medicationToEdit?.instructions ?: "") }
    var selectedColor by remember { mutableStateOf(medicationToEdit?.color ?: _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedConstants.PresetColors.first()) }
    var status by remember { mutableStateOf(medicationToEdit?.status ?: _root_ide_package_.com.group8.comp2300.presentation.screens.medical.MedicationStatus.Active) }
