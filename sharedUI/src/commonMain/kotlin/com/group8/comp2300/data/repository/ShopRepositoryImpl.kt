...
class ShopRepositoryImpl(private val apiService: ApiService) : ShopRepository {
    override suspend fun getAllProducts(): List<Product> = apiService.getProducts().map { it.toDomain() }
    ...
    override suspend fun getProductById(id: String): Product = apiService.getProduct(id).toDomain()
}
