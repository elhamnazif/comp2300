    ...
    questions = listOf(
        ...
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-ss3b",
                    "Because most people with STDs do not have symptoms but can still pass the infection.",
                    true,
                ),
        ...
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-ss6c",
                    "Finish all medication and ensure your partner is also treated before having sex again.",
                    true,
                ),
    ...
    questions = listOf(
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-t1b",
                    "You should get tested if you have had any kind of unprotected sexual contact.",
                    true,
                ),
                QuizOption(
                    "opt-t1c",
                    "You are automatically tested for all STDs during a regular physical exam.",
                    false,
                ),
    ...
    questions = listOf(
        ...
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-p6b",
                    "It means there is a serious medical problem that needs immediate surgery.",
                    false,
                ),
    ...
    questions = listOf(
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-h1b",
                    "HIV is the virus that attacks the immune system, and AIDS is the advanced stage of that infection.",
                    true,
                ),
        ...
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-h2b",
                    "It breaks down the digestive system so the body cannot absorb nutrients.",
                    false,
                ),
                QuizOption(
                    "opt-h2c",
                    "It attacks and destroys T cells (CD4 cells), which help the body fight off infections.",
                    true,
                ),
        ...
        QuizQuestion(
            ...
            options = listOf(
                QuizOption(
                    "opt-h3a",
                    "Through casual contact like hugging, shaking hands, or sharing a toilet seat.",
                    false,
                ),
        ...
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-h4b",
                    "No, but there are highly effective treatments (ART) that allow people to live long, healthy lives.",
                    true,
                ),
                QuizOption("opt-h4c", "Yes, but the cure only works for people who catch it very early.", false),
                QuizOption(
                    "opt-h4d",
                    "No, HIV is always a terminal illness that results in death within a year.",
                    false,
                ),
            ),
        ),
        QuizQuestion(
            ...
            options = listOf(
                ...
                QuizOption(
                    "opt-h5b",
                    "To prevent the virus from being passed to the baby during pregnancy or birth.",
                    true,
                ),
                QuizOption(
                    "opt-h5c",
                    "Because HIV medicine is the only way to ensure the baby is the correct gender.",
                    false,
                ),
