...
val article1 = Article(
    ...
    images = listOf(
        ArticleImage(
            "img1",
            "https://nextcare.com/wp-content/uploads/2024/11/infographic-how-to-practice-safe-sex-scaled.jpg",
            "Infographic on hot to prevent sexually transmitted disease, published by Next Care.",
        ),
    ),
)
...
val article2 = Article(
    ...
    images = listOf(
        ArticleImage(
            "img2",
            "https://www.utsc.utoronto.ca/hwc/sites/utsc.utoronto.ca.hwc/files/styles/original_image/public/images/page/STI%20test.PNG?itok=B97gnaC1",
            "Types of tests for STDs",
        ),
        ArticleImage(
            "img3",
            "https://www.nm.org/-/media/northwestern/healthbeat/images/healthy-tips/nm-sti-testing_infographic.jpg",
            "An infographic published by Northwestern Medicine: STI Testing - Who, What and When?",
        ),
    ),
)
...
val article3 = Article(
    ...
    images = listOf(
        ArticleImage(
            "img4",
            "https://images.ctfassets.net/aqfuj2z95p5p/1A84Dh9CVXtOOsq2nZtxhF/75b68b1df5428e345eb3274f6efc0497/Always_EN_UK_Articles_A115-All-about-the-female-menstrual-cycle_ALWAYS-Menstrual-cycle-infographic.png",
            "An infographic on the menstrual cycle",
        ),
    ),
)
...
val article4 = Article(
    ...
    images = listOf(
        ArticleImage(
            "img5",
            "https://hivinfo.nih.gov/sites/default/files/styles/700w/public/infographics/PNG/hiv-and-aids_en.png?itok=EU74JZxg",
            "Infographic on the difference between HIV and AIDS, published by the National Library of Medicine (NIH)",
        ),
        ArticleImage(
            "img6",
            "https://images.everydayhealth.com/images/seo-graphic-content-initiative/how-hiv-infection-affects-the-body.png?w=1110",
            "Created by Everyday Health",
        ),
    ),
)
