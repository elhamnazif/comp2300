...
interface MedicationLogDataRepository {
    ...
    suspend fun getRoutineAgendaRange(startDate: String, endDate: String): Map<String, List<RoutineDayAgenda>>

    suspend fun getManualMedicationLogs(date: String): List<MedicationLog>

    suspend fun getManualMedicationLogsRange(startDate: String, endDate: String): Map<String, List<MedicationLog>>
