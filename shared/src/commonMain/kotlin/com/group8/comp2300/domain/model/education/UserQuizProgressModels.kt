...
@Serializable
data class UserQuizAnswer(val id: String, val attemptId: String, val questionId: String?, val selectedOptionId: String?)
...
@Serializable
data class EducationProgress(val stats: UserQuizStats, val earnedBadges: List<EarnedBadge> = emptyList())
